...
export async function POST(endpoint: string, body: Record<string, string>) {
  return await makeRequest(endpoint, 'POST', body)
}

export async function PATCH(endpoint: string, body: Record<string, string>) {
  return await makeRequest(endpoint, 'PATCH', body)
}

export async function PUT(endpoint: string, body: Record<string, string>) {
